...
export function NotebookSessionTimeline({ chronicleId, sessions, notes, canManage, onShowSessionNotes }: Props) {
  ...
  return <section className="nb2-session-workspace">
    <header className="nb2-session-heading"><div><small>HISTORIAL DE LA CRÓNICA</small><h2>Sesiones</h2><p>Una línea temporal para recordar qué ocurrió y retomarlo sin perder contexto.</p></div><span className="nb2-session-count">{sessions.length} sesiones</span></header>
