      ...
      <div className="identity-header-layout">
        ...
        <div className="identity-header-main">
          ...
          <div className="identity-grid">
            <IdentityField label="Concepto" value={character.concept} featured />
            {!human ? (
              <IdentityField
                label="Depredador"
                value={transitionalValue(character.predatorType, profilePhase)}
              />
            ) : null}
            <IdentityField label="Crónica" value={character.chronicle} />
            <IdentityField label="Ambición" value={character.ambition} featured />
            {!human ? (
              <>
                <IdentityField
                  label="Clan"
                  value={transitionalValue(character.clan, profilePhase)}
                />
                <IdentityField
                  label="Generación"
                  value={transitionalValue(character.generation, profilePhase)}
                />
                <IdentityField
                  label="Sire"
                  value={transitionalValue(character.sire, profilePhase)}
                />
              </>
            ) : null}
            <IdentityField label="Deseo" value={character.desire} featured />
          </div>
        </div>
      </div>
    </section>
