...
|---|---|---:|---|---|---|
| SPEC-001 | [SPEC-001 -- PROJECT_BOOTSTRAP.md](SPEC-001_PROJECT_BOOTSTRAP_v1.0.md) | 1.0 | Aprobado | Cerrada | Bootstrap portable, Docker/Compose, frontend/API, estructura modular y validacion de servidor limpio acreditados. |
| SPEC-002 | [SPEC-002 -- SERVER_INFRASTRUCTURE](SPEC-002_SERVER_INFRASTRUCTURE_v1.0.md) | 1.0 | Aprobado | Cerrada | Infraestructura, SSH, contenedores, seguridad, monitorizacion, recuperacion y documentacion operativas acreditadas. |
| SPEC-003 | [SPEC-003 -- DOCKER_ARCHITECTURE](SPEC-003_DOCKER_ARCHITECTURE_v1.0.md) | 1.0 | Aprobado | Cerrada | Docker/Compose, servicios aislados, red application, volumenes, healthchecks, reinicio y builds reproducibles validados. |
| SPEC-004 | [SPEC-004 -- PROJECT_STRUCTURE](SPEC-004_PROJECT_STRUCTURE_v1.0.md) | 1.0 | Aprobado | Cerrada | Estructura modular apps/packages/docs/scripts, convenciones, ubicaciones y ausencia de directorios redundantes validadas. |
| SPEC-005 | [SPEC-005 -- DEVELOPMENT_WORKFLOW](SPEC-005_DEVELOPMENT_WORKFLOW_v1.0.md) | 1.0 | Aprobado | Cerrada | Workflow incremental, Git, checks, typecheck, tests, Docker y documentacion sincronizada validados. |
| SPEC-006 | [SPEC-006 -- DEPLOYMENT](SPEC-006_DEPLOYMENT_v1.0.md) | 1.0 | Aprobado | Cerrada | Despliegue portable, migraciones, arranque/parada, backup previo, restore verificado y recuperacion desde servidor limpio validados. |
| SPEC-007 | [SPEC-007 -- BACKUP_AND_RECOVERY](SPEC-007_BACKUP_AND_RECOVERY_v1.0.md) | 1.0 | Aprobado | Cerrada | Backup completo portable, retencion, programacion Docker, checksums, restauracion y recuperacion reproducible validados. |
| SPEC-008 | [SPEC-008 – SYSTEM_MONITORING](SPEC-008_SYSTEM_MONITORING_v1.0.md) | 1.0 | Aprobado | Cerrada | Healthchecks, estado Docker, logs, diagnostico, recursos, version y estado de backups consultables validados. |
| SPEC-009 | [SPEC-009 – MAINTENANCE_OPERATIONS](SPEC-009_MAINTENANCE_OPERATIONS_v1.0.md) | 1.0 | Aprobado | Cerrada | Start/stop/restart/status/logs/health/backup/restore/update/rollback por SSH con procedimientos reproducibles validados. |
...
| SPEC-025 | [SPEC-025 – CHARACTER_DISCIPLINES_AND_POWERS](SPEC-025_CHARACTER_DISCIPLINES_AND_POWERS_v1.0.md) + [Adendas A1–A11](SPEC-025_ADDENDA_A1_A11_DISCIPLINE_MECHANICS_v1.0.md) | 1.0 + A1–A11 | Aprobado | Cerrada | Catálogo mecanizado 106/106, afinidades, persistencia, ficha, evolución y trazabilidad A1–A11 validadas. |
...
| SPEC-035 | [SPEC-035 – CHRONICLE_SESSIONS](SPEC-035_CHRONICLE_SESSIONS_v1.0.md) | 1.0 | Aprobado | Cerrada | CRUD de sesiones, preparación/completado/archivado, resumen y notas privadas, numeración y fecha flexibles, contexto por referencias, asistencia, permisos y preservación histórica validados; tiempo real, sharing avanzado y automatización futura de dados quedan fuera de esta primera implementación. |
| SPEC-036 | [SPEC-036 – DICE_MODULE](SPEC-036_DICE_MODULE_v1.0.md) | 1.0 | Aprobado | Cerrada | Motor d10 independiente, reservas genéricas, Dados normales y de Hambre, interpretación V5 centralizada, tiradas manuales y desde personaje, permisos, API y presentación estructurada validados; ampliaciones de pool preview, resultados especiales e historial quedan reguladas por SPEC-037, SPEC-038 y SPEC-039. |
| SPEC-037 | [SPEC-037 – DICE_POOLS_AND_ROLLS](SPEC-037_DICE_POOLS_AND_ROLLS_v1.0.md) | 1.0 | Aprobado | Cerrada | Constructor flexible de reservas, componentes y modificadores, reparto de Hambre, dificultad, preview sin consumir aleatoriedad, tiradas manuales y vinculadas, congelación de datos y contratos API/web validados; rerolls e historial quedan regulados por SPEC-039. |
| SPEC-038 | [SPEC-038 – DICE_HUNGER_AND_SPECIAL_RESULTS](SPEC-038_DICE_HUNGER_AND_SPECIAL_RESULTS_v1.0.md) | 1.0 | Aprobado | Cerrada | Dados normales y de Hambre identificados explícitamente, críticos y críticos conflictivos, fallos bestiales, prioridad de clasificación, dificultad, casos límite, aleatoriedad controlable, presentación accesible y conservación histórica validados; consecuencias narrativas quedan fuera del motor. |
| SPEC-039 | [SPEC-039 – DICE_HISTORY_AND_CONTEXT](SPEC-039_DICE_HISTORY_AND_CONTEXT_v1.0.md) | 1.0 | Aprobado | Cerrada | Snapshots históricos inmutables y versionados, contexto opcional de personaje/crónica/sesión, visibilidad contextual y privada, permisos backend, filtros, paginación por cursor, detalle web y relaciones de reroll validados; auditoría técnica, purgado automático y exportación quedan fuera del alcance inicial. |
| SPEC-040 | [SPEC-040 – ADMINISTRATION_MODULE](SPEC-040_ADMINISTRATION_MODULE_v1.0.md) | 1.0 | Aprobado | Cerrada | Hub administrativo restringido, usuarios, roles, credenciales, estado, backups, operaciones, auditoria y UI modular validados. |
